...
const Home = () => {
  ...
  return (
    <>
      <div className=" flex flex-col w-full items-end  min-h-[1115px] max-md:px-5 bg-gray-50">
            ...
            <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
              <div className="flex relative flex-col self-stretch mx-4 mt-52 max-md:mt-10 max-md:max-w-full">
                ...
                <div className="mt-6 text-base font-normal  leading-8 text-gray-500 max-md:max-w-full">
                  Dive into a world where wagging tails and purring
                  companionship await. Our pet-centric haven is a one-stop
                  destination for all your furry friend&apos;s needs. From
                  gourmet treats to stylish accessories, we&apos;ve got
                  everything to make tails wag and hearts flutter.
                </div>
