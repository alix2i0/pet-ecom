        ...
        <div className="bg-gray-100 min-h-screen flex items-center justify-center">
            <div className="max-w-lg mx-auto bg-white rounded-lg shadow-md p-5">
                ...
                <div className="flex justify-center mt-5">
                    <a href="#" className="text-amber-600 hover:text-amber-700 mx-3">Twitter</a>
                    <a href="#" className="text-amber-600 hover:text-amber-700 mx-3">LinkedIn</a>
                    <a href="#" className="text-amber-600 hover:text-amber-700 mx-3">GitHub</a>
                </div>
                <div className="mt-5">
